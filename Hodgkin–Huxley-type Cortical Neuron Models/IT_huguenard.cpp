...
#define shift _ml->template fpfield<1>(_iml)
...
#define carev _ml->template fpfield<11>(_iml)
#define carev_columnindex 11
#define phi_h _ml->template fpfield<12>(_iml)
#define phi_h_columnindex 12
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"shift"} /* 1 */,
                                       ...
                                       _nrn_mechanism_field<double>{"carev"} /* 11 */,
                                       _nrn_mechanism_field<double>{"phi_h"} /* 12 */,
...
static int _reset;
static const char *modelname = "Low threshold calcium current";
...
static void _hoc_evaluate_fct(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for evaluate_fct_it. Requires prior call to setdata_it and that the specified mechanism instance still be in existence.", NULL);
  }
