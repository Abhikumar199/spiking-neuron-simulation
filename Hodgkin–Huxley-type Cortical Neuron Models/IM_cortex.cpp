...
#define tau_peak _ml->template fpfield<7>(_iml)
#define tau_peak_columnindex 7
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"tau_peak"} /* 7 */,
...
static void _hoc_evaluate_fct(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for evaluate_fct_im. Requires prior call to setdata_im and that the specified mechanism instance still be in existence.", NULL);
  }
